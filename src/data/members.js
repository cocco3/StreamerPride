export default [
  ...
  },
  {
    ...
    description: 'André is a videogame streamer focusing primarily on J-RPGs, a genre he has adored since his parents bought him a Gameboy Color with Pokémon Gold as a child. He is one of the network’s co-founders and has made cultivating a welcoming experience to all a stated aim of his streams from the beginning. He tries to bring humour, filth, and occasionally the informative lense of his Japan Studies degree to his streams and the games he plays.'
  },
  {
    founder: true,
    name: 'KayteeKhaos',
    ...
    description: 'Kate lives in North Wales with her cat Geralt and has been a passionate gamer since the mid 80s when she first came into possession of a ZX Spectrum. Her game of choice is Elite Dangerous. When she’s not gaming or streaming she works for LGBT+ charity Diversity Role Models.'
  },
  {
    name: 'blizzb3ar',
    pronouns: 'He/Him',
  ...
  },
  {
    ...
    description: 'Capn/Foam, or Kyle, spends a lot of their time exploring the vast wastelands, forests, and bays showcased not only in their favorite video games but in the great outdoors as well. They are a variety streamer that finds joy in MMORPGs, RPGs, various MOBAs, and games that focus heavily in story and character development. Twitch has become a safe space for them and building a supportive community really lights the fire inside their heart. When they are not live, you can find them cruising local eateries, writing fantasy short-stories, and dancing like no one is watching. They live in Colorado with their 2 lovely kitties: Noodle and Skedoodle.'
  },
  {
    name: 'Cenric89',
    pronouns: 'He/Him',
    twitchUrl: 'https://www.twitch.tv/cenric89',
    description: 'Emre (Em-ray) is a lover, child, mother, sinner, saint, AND a variety streamer with a somewhat larger focus on jRPGs and multiplayer games. He has been gaming since pre-school, social since birth, what better way to game and be social at the same than to stream? A big fan of laughs, flamboyant humour, and contemporary media, Emre enjoys peppering his streams with small talk - just like in his lessons, a warm atmosphere is always the mood. Stop by for the games, stay for the fun!'
  },
  {
    name: 'Chemicollins',
    pronouns: 'He/Him',
    twitchUrl: 'https://www.twitch.tv/Chemicollins',
    description: `If you watch Sam, you'll get plenty of drunk shenanigans, gay shit, and questionable dance moves. He mainly enjoys story-driven games, but he plays all sorts of titles.
    Sam has been a gamer since he was 5 years old and started with Donkey Kong Country on SNES. Nowadays, he's a full-fledged geek playing on his PC, PS4, and Switch.
  ...
  },
  {
    ...
    description: 'Jonattan. Music producer and gaymer from Orlando, Fl. Regardless of the wide variety of games that he streams, hack-n-slash will always be the go to but never shying away from streaming all genres from action RPGs, to Battle Royale games, to VR, to FPS and 3rdPS, 1v1 fighting games, side scroll games, hack-n-slash, visual novels… the list literally goes on. His main passion is music and hopes to spread support for LGBT communities & mental health awareness throughout the world.'
  },
  {
    name: 'rac_kuhns',
    pronouns: 'He/Him',
    twitchUrl: 'https://www.twitch.tv/rac_kuhns',
    description: 'Rac, or Will, grew up playing The Legend of Zelda, Pokemon and spending hours in Golden Sun. He streams a variety of genres including MMORPGs, JRPGS, MOBAs and action-adventures. Streaming is his avenue to share his love of video games with others while making it engaging for viewers. Outside of gaming he cycles, tours wineries and is a full-time marketer and website manager for a health care non-profit. He lives in Virginia with his cuddly cat Boh.'
  }
]